# Idéia do PR do colega Carlos Souza
# https://github.com/tryber/sd-07-project-ting/blob/carlos-souza-project-ting/ting_word_searches/word_search.py
